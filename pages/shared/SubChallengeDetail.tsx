                ...
                {submission.evaluation ? (
                    <Card>
                        ...
                        <div className="space-y-2 mb-4">
                           {submission.results.map(result => {
                                const evalResult = submission.evaluation?.result_evaluations.find(e => e.result_id === result.id);
                         ...
                         {subChallenge.evaluation_rules.report.enabled && (
                            <div className="flex justify-between items-center text-sm mb-4">
                               ...
                               <span>{submission.evaluation.report_score || 0} / {subChallenge.evaluation_rules.report.maxScore}</span>
                            </div>
                         )}
                         <h3 className="text-lg font-semibold mb-2">Evaluator Feedback</h3>
                         <p className="text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-900 p-3 rounded-md">{submission.evaluation.feedback}</p>
                    </Card>
                ) : (
